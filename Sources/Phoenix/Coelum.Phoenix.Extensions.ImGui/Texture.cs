...
namespace Coelum.Phoenix.Extensions.ImGui {
	...
	class Texture : IDisposable {
		...
		public unsafe Texture(GL gl, int width, int height, IntPtr data, bool generateMipmaps = false,
		                      bool srgb = false) {
			_gl = gl;
			...
			_gl.TexSubImage2D(GLEnum.Texture2D, 0, 0, 0, Width, Height, pxFormat, PixelType.UnsignedByte,
			                  (void*) data);
			...
			_gl.TexParameter(GLEnum.Texture2D, TextureParameterName.TextureMaxLevel, MipmapLevels - 1);
		}
		...
		public void SetMinFilter(TextureMinFilter filter) {
			_gl.TexParameter(GLEnum.Texture2D, TextureParameterName.TextureMinFilter, (int) filter);
		}

		public void SetMagFilter(TextureMagFilter filter) {
			_gl.TexParameter(GLEnum.Texture2D, TextureParameterName.TextureMagFilter, (int) filter);
		}
		...
		public void SetLod(int @base, int min, int max) {
			_gl.TexParameter(GLEnum.Texture2D, TextureParameterName.TextureLodBias, @base);
			_gl.TexParameter(GLEnum.Texture2D, TextureParameterName.TextureMinLod, min);
			_gl.TexParameter(GLEnum.Texture2D, TextureParameterName.TextureMaxLod, max);
		}

		public void SetWrap(TextureCoordinate coord, TextureWrapMode mode) {
			_gl.TexParameter(GLEnum.Texture2D, (TextureParameterName) coord, (int) mode);
		}
